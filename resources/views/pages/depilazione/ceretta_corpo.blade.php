...
<script>
    $(document).ready(function() {
        ...
        function aggiornaSaloni() {
            ...
            $.ajax({
                url: "{{ route('pages.depilazione.ceretta_corpo') }}",
                type: "GET",
                data: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const aggiornaRisultati = () => {
        ...
        fetch(`{{ route('pages.depilazione.ceretta_corpo') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`, {
            headers: {
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const aggiornaRisultati = () => {
            ...
            window.location.href = `{{ route('pages.depilazione.ceretta_corpo') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`;
        };
...
$(document).ready(function() {
    ...
    $('#reset').on('click', function() {
        ...
        window.location.href = "{{ route('pages.depilazione.ceretta_corpo') }}"; // Reindirizza a /piega
    });
});
</script>
