...
<head>
    ...
    <title>Depilazione con filo orientale sopracciglia</title>
...
<script>
    $(document).ready(function() {
        ...
        function aggiornaSaloni() {
            ...
            $.ajax({
                url: "{{ route('pages.viso.colorazione_ciglia_e_sopracciglia') }}",
                type: "GET",
                data: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const aggiornaRisultati = () => {
        ...
        fetch(`{{ route('pages.viso.colorazione_ciglia_e_sopracciglia') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`, {
            headers: {
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const aggiornaRisultati = () => {
            ...
            window.location.href = `{{ route('pages.viso.depilazione_con_filo_orientale_sopracciglia') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`;
        };
...
<script>
    function aggiornaSaloni() {
        ...
        $.ajax({
            url: "{{ route('pages.viso.depilazione_con_filo_orientale_sopracciglia') }}",
            type: "GET",
            data: {
                trattamento: trattamento,
                posizione: posizione,
...
$(document).ready(function() {
    ...
    $('#reset').on('click', function() {
        ...
        window.location.href = "{{ route('pages.viso.depilazione_con_filo_orientale_sopracciglia') }}"; // Reindirizza a /piega
    });
});
</script>
