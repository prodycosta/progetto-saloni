...
<head>
    ...
    <title>Colorazione ciglia e sopracciglia</title>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const aggiornaRisultati = () => {
            ...
            window.location.href = `{{ route('pages.viso.colorazione_ciglia_e_sopracciglia') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`;
        };
...
$(document).ready(function() {
    ...
    $('#reset').on('click', function() {
        ...
        window.location.href = "{{ route('pages.viso.colorazione_ciglia_e_sopracciglia') }}"; // Reindirizza a /piega
    });
});
</script>
