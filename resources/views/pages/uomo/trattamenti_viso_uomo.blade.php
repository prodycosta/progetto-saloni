...
<head>
    ...
    <title>Trattamenti viso uomo</title>
...
<script>
    $(document).ready(function() {
        ...
        function aggiornaSaloni() {
            ...
            $.ajax({
                url: "{{ route('pages.viso.trattamenti_viso') }}",
                type: "GET",
                data: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const aggiornaRisultati = () => {
        ...
        fetch(`{{ route('pages.viso.trattamenti_viso') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`, {
            headers: {
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const aggiornaRisultati = () => {
            ...
            window.location.href = `{{ route('pages.uomo.trattamenti_viso_uomo') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`;
        };
...
<script>
    function aggiornaSaloni() {
        ...
        $.ajax({
            url: "{{ route('pages.uomo.trattamenti_viso_uomo') }}",
            type: "GET",
            data: {
                trattamento: trattamento,
                posizione: posizione,
...
$(document).ready(function() {
    ...
    $('#reset').on('click', function() {
        ...
        window.location.href = "{{ route('pages.uomo.trattamenti_viso_uomo') }}"; // Reindirizza a /piega
    });
});
</script>
