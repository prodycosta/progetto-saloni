...
<div style="display: flex; width: 100%; height: 100%;">
    ...
    <div style="display: none;">
        <select class="form-select mb-2" id="posizioneSelect" name="posizione" onclick="toggleDropdown('dropdownMenu')" style="height: 38px;width:300px; font-size: 14px; color: #495057; border: 1px solid #ced4da; border-radius: 10px 0px 0px 10px;" required>
            ...
            <option value="Per uomo">Per uomo</option>
        </select>
    ...
    <div class="mb-3">
        <input type="date" class="form-control" id="dataInput" name="data" style="height: 38px; padding: 0.375rem 0.75rem; border-radius: 10px; border: 1px solid #ced4da; width: 100%;" required>
    </div>
    <div class="mb-3">
        <div class="input-group justify-content-center mx-auto" style="width: 100%;height: 38px;">
            <input type="text" class="form-control" id="posizioneInput" name="posizione" style="height: 38px; border-right: none; border-radius: 10px 0px 0px 10px;" placeholder="Posizione" required>
            <div class="input-group-append">
...
<div class="filtri">
    ...
    <p class="saloni-message">Scegli fra i vari saloni che offrono {{ $title }}</p>
        ...
        <div class="radio-container" style="display: flex; align-items: flex-start;">
            <label for="raccomandato">Raccomandato</label>
            <input type="radio" id="raccomandato" name="ordina" value="raccomandato">
        </div>
        <div class="radio-container" style="display: flex; align-items: flex-start;">
        ...
        <div class="radio-container" style="display: flex; align-items: flex-start;">
            ...
            <input type="radio" id="sconto" name="ordina" value="sconto">
        </div>
    </form>
    <hr>
    <h5>Prezzo</h5>
...
<script>
    function mostraImmagine(indiceContenuto, indiceImmagine) {
        let immaginiSalone = document.querySelectorAll(`.contenuto:nth-child(${indiceContenuto + 1}) .immagini img`);
...
<script>
    function aggiornaSaloni() {
        ...
        $.ajax({
            url: "{{ route('pages.capelli.taglio_uomo') }}",
            type: "GET",
            data: {
...
$(document).ready(function() {
    ...
    $('#reset').on('click', function() {
        ...
        window.location.href = "{{ route('pages.capelli.taglio_uomo') }}"; // Reindirizza a /piega
    });
});
</script>
