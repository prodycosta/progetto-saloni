...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const aggiornaRisultati = () => {
            ...
            window.location.href = `{{ route('pages.capelli.colpi_di_sole') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`;
        };
...
<script>
    function aggiornaSaloni() {
        ...
        $.ajax({
            url: "{{ route('pages.capelli.colpi_di_sole') }}",
            type: "GET",
            data: {
                trattamento: trattamento,
                posizione: posizione,
...
$(document).ready(function() {
    ...
    $('#reset').on('click', function() {
        ...
        window.location.href = "{{ route('pages.capelli.colpi_di_sole') }}"; // Reindirizza a /piega
    });
});
</script>
