...
<style>
    ...
    <style>
        ...
        .contenuto:hover {
    box-shadow: 2px 2px 2px 1px rgba(185, 217, 235, 0.5); /* Ombratura con il colore B9D9EB */
    border: 1px solid #B9D9EB; /* Bordo con colore B9D9EB */
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const aggiornaRisultati = () => {
        ...
        fetch(`{{ route('pages.capelli.piega') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`, {
            headers: {
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const aggiornaRisultati = () => {
            ...
            window.location.href = `{{ route('pages.capelli.piega') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`;
        };
...
$(document).ready(function() {
    ...
    $('#reset').on('click', function() {
        ...
        window.location.href = "{{ route('pages.capelli.piega') }}"; // Reindirizza a /piega
    });
});
</script>
