...
<head>
    ...
    <title>Taglio e piega donna</title>
...
<script>
    $(document).ready(function() {
        ...
        function aggiornaSaloni() {
            ...
            $.ajax({
                url: "{{ route('pages.capelli.trattamenti_capelli_specifici') }}",
                type: "GET",
                data: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const aggiornaRisultati = () => {
        ...
        fetch(`{{ route('pages.capelli.trattamenti_capelli_specifici') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`, {
            headers: {
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const aggiornaRisultati = () => {
            ...
            window.location.href = `{{ route('pages.capelli.taglio_e_piega_donna') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`;
        };
...
<script>
    function aggiornaSaloni() {
        ...
        $.ajax({
            url: "{{ route('pages.capelli.taglio_e_piega_donna') }}",
            type: "GET",
            data: {
                trattamento: trattamento,
                posizione: posizione,
...
$(document).ready(function() {
    ...
    $('#reset').on('click', function() {
        ...
        window.location.href = "{{ route('pages.capelli.taglio_e_piega_donna') }}"; // Reindirizza a /piega
    });
});
</script>
