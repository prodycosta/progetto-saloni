...
<head>
    ...
    <title>Trattamenti capelli specifici</title>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const aggiornaRisultati = () => {
            ...
            window.location.href = `{{ route('pages.capelli.trattamenti_capelli_specifici') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`;
        };
...
$(document).ready(function() {
    ...
    $('#reset').on('click', function() {
        ...
        window.location.href = "{{ route('pages.capelli.trattamenti_capelli_specifici') }}"; // Reindirizza a /piega
    });
});
</script>
