...
<head>
    ...
    <title>Trattamenti dimagranti</title>
...
<script>
    $(document).ready(function() {
        ...
        function aggiornaSaloni() {
            ...
            $.ajax({
                url: "{{ route('pages.corpo.trattamenti_dimagranti') }}",
                type: "GET",
                data: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const aggiornaRisultati = () => {
        ...
        fetch(`{{ route('pages.corpo.trattamenti_dimagranti') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`, {
            headers: {
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const aggiornaRisultati = () => {
            ...
            window.location.href = `{{ route('pages.corpo.trattamenti_dimagranti') }}?trattamento=${trattamento}&data=${data}&posizione=${posizione}`;
        };
...
$(document).ready(function() {
    ...
    $('#reset').on('click', function() {
        ...
        window.location.href = "{{ route('pages.corpo.trattamenti_dimagranti') }}"; // Reindirizza a /piega
    });
});
</script>
